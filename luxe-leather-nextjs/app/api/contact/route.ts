...
import { sendAdminContactNotification, sendCustomerContactConfirmation } from '@/lib/utils/email';
...
// Email functions are now handled by /lib/utils/email.ts using Nodemailer
