...
\restrict YtH28mtDRgDHa8Sn1HgNdsozfDbjeqmthmhBsQwdPvFdhVRIxm9FSZa0lafERIw
...
CREATE POLICY "Allow Public Access" ON storage.objects FOR SELECT USING ((bucket_id = 'media'::text));


--
-- Name: objects Allow Public Upload; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Allow Public Upload" ON storage.objects FOR INSERT WITH CHECK ((bucket_id = 'media'::text));
...
\unrestrict YtH28mtDRgDHa8Sn1HgNdsozfDbjeqmthmhBsQwdPvFdhVRIxm9FSZa0lafERIw
