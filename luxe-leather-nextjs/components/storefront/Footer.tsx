    ...
    const handleNewsletter = async () => {
        ...
        try {
            const res = await fetch('/api/contact', {
                ...
                body: JSON.stringify({ name: 'Newsletter Subscriber', email: newsletterEmail, inquiry_type: 'newsletter', message: 'Newsletter subscription' }),
            });
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <button
                                    ...
                                    className="absolute right-0 bottom-3 text-[#c27a2a] text-[9px] font-black uppercase tracking-[0.2em] hover:text-white transition-colors disabled:opacity-50"
                                >
                                    {newsletterStatus === 'submitting' ? '...' : newsletterStatus === 'success' ? '✓' : 'Join'}
                                </button>
                            </div>
                            {newsletterStatus === 'success' && <p className="text-emerald-400 text-[10px] mt-1">Subscribed!</p>}
                            {newsletterStatus === 'error' && <p className="text-red-400 text-[10px] mt-1">Failed. Try again.</p>}
                        </div>

                        {/* Social Icons */}
                        <div className="flex gap-5">
                            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-500 hover:text-[#c27a2a] transition-all">
                            ...
                            <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" className="text-gray-500 hover:text-[#c27a2a] transition-all">
